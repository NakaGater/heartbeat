...
```json
{"from": "designer", "to": "architect", "action": "decompose", "output": "design.md", "status": "ok", "note": "{summary in user's language}", "timestamp": "(ISO 8601 UTC — agent writes current time)"}
```
