...
```json
{"from": "context-manager", "to": "pdm", "action": "define_story", "output": "context.md", "status": "ok", "note": "{summary in user's language}", "timestamp": "(ISO 8601 UTC — agent writes current time)"}
```
