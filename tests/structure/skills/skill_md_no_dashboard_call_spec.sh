...
Describe 'Explicit generate-dashboard.sh Calls Removed from SKILL.md (Task 3)'
  Describe 'core/skills/heartbeat/SKILL.md'
    It 'does not contain generate-dashboard.sh string'
  ...
  Describe 'core/skills/heartbeat-backlog/SKILL.md'
    It 'Dashboard Sync section does not exist'
