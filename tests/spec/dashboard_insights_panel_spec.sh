Describe 'generate-dashboard.sh: Dashboard Integration - INSIGHTS_DATA Injection and User Insights Panel (Task 5)'
  setup() {
  ...
  It 'includes User Insights panel in generated HTML'
    echo '{"id":"RAW-001","source_type":"interview","source_ref":"test.md","title":"テスト","excerpt":"要約","created_by":"insight-analyst","timestamp":"2026-04-04T10:00:00Z"}' \
      > "$TEST_HEARTBEAT/insights/raw.jsonl"
  ...
  It 'uses var instead of const for INSIGHTS_DATA declaration (ES5 compliant)'
    echo '{"id":"RAW-001","source_type":"interview","source_ref":"test.md","title":"テスト","excerpt":"要約","created_by":"insight-analyst","timestamp":"2026-04-04T10:00:00Z"}' \
      > "$TEST_HEARTBEAT/insights/raw.jsonl"
